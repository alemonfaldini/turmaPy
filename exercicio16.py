16. #Escreva um algoritmo para ler o número total de eleitores de um município,
...
def eleicao():
    ...
    if ((brancos+nulos+validos) == total):
        ...
        return 'Número de brancos, validos e nulos é diferente do total de eleitores, digitar novamente'
